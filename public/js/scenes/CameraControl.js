...
export default class CameraControl {
    ...
    update() {
        if (this.isCameraFollowing) {
            this.scene.cameras.main.scrollX = this.player.x - this.scene.cameras.main.width / 2;
            this.scene.cameras.main.scrollY = this.player.y - this.scene.cameras.main.height / 2;
        }
    }
}
