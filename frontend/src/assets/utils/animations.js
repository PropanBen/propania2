...
export function registerAnimalAnimations(scene) {
	const animations = [
		...
		{ key: "sheep_walk_up", row: 3, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_walk_down", row: 0, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_walk_left", row: 1, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_walk_right", row: 2, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_run_up", row: 3, startColumn: 0, endColumn: 2, frameRate: 10 },
		{ key: "sheep_run_down", row: 0, startColumn: 0, endColumn: 2, frameRate: 10 },
		{ key: "sheep_run_left", row: 1, startColumn: 0, endColumn: 2, frameRate: 10 },
		{ key: "sheep_run_right", row: 2, startColumn: 0, endColumn: 2, frameRate: 10 },
		{ key: "sheep_attack_up", row: 3, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_attack_down", row: 3, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_attack_left", row: 3, startColumn: 0, endColumn: 2, frameRate: 6 },
		{ key: "sheep_attack_right", row: 3, startColumn: 0, endColumn: 2, frameRate: 6 },
