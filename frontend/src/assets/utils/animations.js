export function registerPlayerAnimations(scene) {
	const animations = [
		...
		{ key: "idle_right", row: 25, startColumn: 0, endColumn: 1, frameRate: 1 },
		{ key: "walk_up", row: 8, startColumn: 0, endColumn: 8, frameRate: 10 },
		{ key: "walk_down", row: 10, startColumn: 0, endColumn: 8, frameRate: 10 },
		{ key: "walk_left", row: 9, startColumn: 0, endColumn: 8, frameRate: 10 },
		{ key: "walk_right", row: 11, startColumn: 0, endColumn: 8, frameRate: 10 },
		...
		{ key: "run_right", row: 41, startColumn: 0, endColumn: 7, frameRate: 10 },
